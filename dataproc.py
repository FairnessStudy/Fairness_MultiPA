...
dataset_orig.to_csv('../Dataset/adult_processed.csv',index=False)




dataset_orig = pd.read_csv('../Dataset/compas.csv')
...
dataset_orig.to_csv('../Dataset/compas_processed.csv',index=False)




dataset_orig = pd.read_csv("../Dataset/default.csv")
dataset_orig = dataset_orig.dropna()
...
dataset_orig.to_csv('../Dataset/default_processed.csv',index=False)




MEPS15 = pd.read_csv('../Dataset/h181.csv')
...
MEPS15.to_csv('../Dataset/mep1_processed.csv',index=False)





MEPS16 = pd.read_csv('../Dataset/h192.csv')
...
MEPS16.to_csv('../Dataset/mep2_processed.csv',index=False)